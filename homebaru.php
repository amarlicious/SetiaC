...
<head>
    ...
    <link rel="stylesheet" href="css/homebaru.css" type="text/css" />
...
<!-- tentang about -->
    <section class="about">
        ...
        <p>SetiaC is an advanced platform designed for efficient reporting and tracking of various issues.
           ...
           monitor progress, and resolve issues promptly. SetiaC update status data collection, user-friendly interfaces,
